...
class DevidenController extends Controller
{
    public function index()
    {
        ...
        $dapur1 = Dapur::orderBy('created_at', 'asc')
            ->get();
        return view('admin.reports.deviden', compact('title', 'dapur1'));
    }
    ...
    public function getData(Request $request)
    {
        ...
        return view('admin.reports.export.deviden', [
    ...
    public function getDataPDF(Request $request)
    {
        ...
        $pdf = PDF::loadView('admin.reports.pdf.deviden', $data->getData())->setPaper('a4');
        return $pdf->download('Laporan_Deviden.pdf');
    }

    public function getDataXls(Request $request)
    {
        return Excel::download(new DevidenExport($request), 'Laporan_Deviden.xlsx');
    }
}
